...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'), # added by win516
            os.path.join(BASE_DIR, 'users/registration/templates'), # added by win516
            ], 
...
STATICFILES_DIRS =[
    ...
    os.path.join(BASE_DIR, 'static'), # added by win516
